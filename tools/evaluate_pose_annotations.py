...
Chạy SAU khi Instructor phát gold. Ngoài điểm số, script trả về một danh sách lỗi
...
def main() -> int:
    ...
    if not arguments.gold.exists():
        print(f"Chưa có gold ở {arguments.gold}. Instructor phát gold sau khi cả lớp khoá nhãn.")
        return 1
    try:
